...
export default function Home() {
  return (
    <div className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 font-sans dark:from-gray-950 dark:via-green-950 dark:to-emerald-950">
      ...
      <section className="relative py-20 px-6 md:px-16 border-green-400 dark:border-green-600">
        <div className="relative z-10">
          <h2 className="text-center text-5xl md:text-7xl font-extrabold mb-4 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent animate-pulse">
            Investing is Easy!
          </h2>
